...
public class GameManager : MonoBehaviour
{
    ...
    private const string DIR_LEVEL = "/Level/";
    private const string DIR_TEXT = "/Text/";
    private const string FILE_LEVEL = "Level";
    private const string FILE_FILETYPE_JSON = ".json";
    ...
    public static int gameObjectArrayForDetect = 2;
    ...
    public void LoadLevelAccordingToTxt()
    {
        ...
        string PATH_FILE_LEVELINDEX = Application.dataPath + DIR_LEVEL + FILE_LEVEL + levelToLoad + FILE_FILETYPE_JSON;
        ...
        if (File.Exists(PATH_FILE_LEVELINDEX))
        {
            ...
            gameObjectArrayForDetect = gameObjectArray;
    ...
    IEnumerator StoryStart()
    {
        ...
        PATH_STORY_START = Application.dataPath + DIR_TEXT + FILE_STORY_START + FILE_FILETYPE_TXT;
    ...
    IEnumerator StoryEnd()
    {
        ...
        PATH_STORY_END = Application.dataPath + DIR_TEXT + FILE_STORY_END + FILE_FILETYPE_TXT;
